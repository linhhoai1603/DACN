...
public class UserSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        List<User> seedUsers = List.of(
                buildUser("Nguyen Van A", "Ha Noi", "vana@example.com", "0912345678", "Password@123", Role.USERS),
                buildUser("Tran Thi B", "Da Nang", "thib@example.com", "0987654321", "Btran@456", Role.DIRECTOR),
                buildUser("Le Van C", "Ho Chi Minh", "vanc@example.com", "0971234567", "Cpass@789", Role.USERS),
                buildUser("Pham Thi D", "Can Tho", "thid@example.com", "0351234567", "Dsecure@012", Role.ADMIN),
                buildUser("Hoang Van E", "Hai Phong", "vane@example.com", "0387654321", "Elogin@345", Role.USERS)
        );
