...
class UserServiceTest {
    ...
    void createUser_Success() {
        ...
        savedUser.setAddress(validRequest.getAddress());
        savedUser.setRole(validRequest.getRole());
        ...
        CreateUserResponse responseBody = (CreateUserResponse) response.getBody();
        assertEquals(1L, responseBody.getId());
        assertEquals("Nguyễn Văn A", responseBody.getFullName());
        assertEquals("test@example.com", responseBody.getEmail());
        assertEquals("Tạo người dùng thành công", responseBody.getMessage());
    ...
    @Test
    @DisplayName("Tạo user thất bại khi số điện thoại đã tồn tại")
    ...
    @Test
    @DisplayName("Tạo user thất bại khi cả email và số điện thoại đã tồn tại")
    void createUser_EmailAndPhoneAlreadyExist() {
    ...
    @Test
    @DisplayName("existsByEmail trả về true khi email tồn tại")
    ...
    @Test
    @DisplayName("existsByEmail trả về false khi email chưa tồn tại")
    ...
    @Test
    @DisplayName("existsByPhone trả về true khi phone tồn tại")
    ...
    @Test
    @DisplayName("existsByPhone trả về false khi phone chưa tồn tại")
